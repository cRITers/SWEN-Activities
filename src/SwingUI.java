...
public class SwingUI extends JFrame implements Observer {
   ...
   private JLabel fahrenField;
   private JLabel inchesField;
   private JLabel milliField;
   ...
   public void update(Observable obs, Object ignore) {
      ...
      setFahrenJLabel(station.getFahrenheit());
      setInchesJLabel(station.getInches());
      setMilliJLabel(station.getMillibars());
   ...
   public void setFahrenJLabel(double temperature) {
      fahrenField.setText(String.format("%6.2f", temperature)) ;
   }
   ...
   public void setMilliJLabel(double temperature) {
      milliField.setText(String.format("%6.2f", temperature)) ;
   }
